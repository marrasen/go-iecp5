...
// F for file transfer.
// <0> unused
// <1..127> standard definitions — compatible
// <128..135> reserved for routing messages — private
// <136..255> special applications — private
// NOTE: Whether information objects include a timestamp is distinguished by different type identifier sequences
const (
	_ TypeID = iota // 0: not defined
	// Process information in monitoring direction <0..44>
	...
	// Process information in control direction <45..69>
	...
	// System commands in monitoring direction <70..99>
	...
	// Parameter commands in control direction <110..119>
...
// seq: bit7
// 0: Collection of information elements of the same type with different objAddress (address+element)*N
// 1: Collection of sequential information elements of the same type with the same objAddress (one address, N elements*N)
...
// Positive or negative confirmation of the activation requested by the start application function 0: positive confirmation, 1: negative confirmation
...
// <0> undefined
// <1..63> Transmission cause number
